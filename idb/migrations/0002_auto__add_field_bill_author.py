...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('idb_bill', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['idb.Senator']),
                      keep_default=False)
    ...
    models = {
        'idb.bill': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['idb.Senator']"}),
            ...
            'primary_committee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'originating_committee_set'", 'null': 'True', 'blank': 'True', 'to': "orm['idb.Committee']"}),
        ...
        'idb.committee': {
            ...
            'chair': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'committee_chair_set'", 'null': 'True', 'blank': 'True', 'to': "orm['idb.Senator']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '70'}),
            ...
            'vice_chair': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'committee_vice_chair_set'", 'null': 'True', 'blank': 'True', 'to': "orm['idb.Senator']"})
        },
        'idb.senator': {
            'Meta': {'object_name': 'Senator'},
            'bills': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'bill_set'", 'symmetrical': 'False', 'blank': 'True', 'to': "orm['idb.Bill']"}),
