...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('idb_committee', (
            ...
            ('chair', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['idb.Senator'], related_name='committee_chair_set')),
            ('vice_chair', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['idb.Senator'], related_name='committee_vice_chair_set')),
        ))
        ...
        db.create_table('idb_bill', (
            ...
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('primary_committee', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['idb.Committee'], related_name='originating_committee_set')),
        ))
    ...
    models = {
        'idb.bill': {
            ...
            'primary_committee': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['idb.Committee']", 'related_name': "'originating_committee_set'"}),
            ...
            'voters': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['idb.Senator']", 'through': "orm['idb.Vote']", 'related_name': "'voted_bill_set'", 'symmetrical': 'False'})
        },
        'idb.committee': {
            'Meta': {'object_name': 'Committee'},
            'appointment_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'chair': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['idb.Senator']", 'related_name': "'committee_chair_set'"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '70'}),
            'senators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['idb.Senator']", 'related_name': "'senator_set'", 'symmetrical': 'False'}),
            'vice_chair': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['idb.Senator']", 'related_name': "'committee_vice_chair_set'"})
        },
        'idb.senator': {
            'Meta': {'object_name': 'Senator'},
            'bills': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['idb.Bill']", 'related_name': "'bill_set'", 'symmetrical': 'False'}),
